...
public class ImgProcesadoNDK extends AppCompatActivity {
    ...
    public native void addMarco(Bitmap bitmapIn, Bitmap bitmapOut);
...
// Asegurar que la imagen tiene 24 bits de color
    ...
    public void onAddMarco(View v) {
        Log.i(tag, "Conversion a escala de sepia");
        bitmapMarco = Bitmap.createBitmap(bitmapOriginal.getWidth(),
                bitmapOriginal.getHeight(), Bitmap.Config.ARGB_8888);
        addMarco(bitmapOriginal, bitmapMarco);
